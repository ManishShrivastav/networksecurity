...
class DataIngestion:
    def __init__(self, data_ingestion_config: DataIngestionConfig):
        """
        Read the data from MongoDB and split it into train and test sets.
        """
        try:
    ...
    def export_data_to_feature_store(self, dataframe: pd.DataFrame) -> str:
        try:
    ...
    def initiate_data_ingestion(self) -> List[str]:
        try:
            dataframe = self.export_collection_as_dataframe(self.data_ingestion_config.collection_name)
